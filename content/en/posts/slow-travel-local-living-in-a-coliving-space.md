---
title: "How to move and do coliving life in a rural area? - Anceu Coliving"
description: "Explore the initial steps in deciding to transition from city life to a rural coliving life. Uncover insights on how to analyze the context of a rural area to determine if it aligns with the lifestyle you seek."
date: 2024-03-05
og_image: /wp-content/uploads/2024/02/arroelo-en-anceu.jpg
slug: slow-travel-local-living-in-a-coliving-space
type: post
---

## My grandmother marked the future of my rural coliving life

If someone had told me a decade ago that my life would revolve around my sheep, [my dogs](https://anceu.com/dog-friendly-coliving-space/), and the beauty of nature, waking up every morning to the soothing melodies of early birds having a rural coliving life, I wouldn’t have believed them.
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnkAAAG7AQAAAACXur4uAAAAAnRSTlMAAHaTzTgAAAA6SURBVHja7cGBAAAAAMOg+VNf4AhVAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADHAIwrAAENH9/UAAAAAElFTkSuQmCC "ninez-1")

![](https://anceu.com/wp-content/uploads/2024/02/ninez-1.jpg "ninez-1")
...
![Espacio Arroelo](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAA44AAAHWAQAAAAAQzuqKAAAAAnRSTlMAAHaTzTgAAABLSURBVHja7cExAQAAAMKg9U9tDB+gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPga0yIAAQA3IMMAAAAASUVORK5CYII= "Espacio Arroelo")

![Espacio Arroelo](https://anceu.com/wp-content/uploads/2024/02/Screenshot-from-2024-03-05-15-51-47.jpg "Espacio Arroelo")

Espacio Arroelo Coworking Space

## Starting Espacio Arroelo

I decided to create a coworking space called [Espacio Arroelo](https://espacioarroelo.es/). This allowed me to build a community close to rural areas in an urban setting. Since 2013, we’ve formed a community of entrepreneurial-minded people. Some are starting their own businesses, others have a strong entrepreneurial spirit within existing companies, some are going through transformative moments where experimenting is crucial, and others have been running their businesses for years but always want to create something new. In this mix and within these environments, more answers start to emerge.
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAyAAAAJYAQAAAACyDb/dAAAAAnRSTlMAAHaTzTgAAABRSURBVHja7cEBDQAAAMKg909tDwcUAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPwb7LgAAUnLD9EAAAAASUVORK5CYII= "arroelo-en-anceu")

![](https://anceu.com/wp-content/uploads/2024/02/arroelo-en-anceu.jpg "arroelo-en-anceu")

First anniversary of Espacio Arroelo at ( future ) Anceu Coliving

## **Second step: rural context to create rural hacking**

For me, living in a rural area doesn’t mean isolating oneself. If someone were to ask for the first piece of advice on how to find a place to live in the countryside, I’d recommend analyzing the context first. I didn’t do it myself; I got lucky! But if I have something to share with you, it’s to look around and understand what’s happening in your surroundings before taking the plunge. What does that mean? Well, I have a lot to share on this topic. Today, I’ll talk about some aspects, and in future posts (we’re committed to meeting once a month on [PonteBlogs](https://ponteblogs.org/)), we can delve into others. In fact, I invite you to explore the manual we’ve put together on this subject. It’s called Rural Hacking, and it revolves around the idea that by collaborating with locals, a sustainable and impactful community can be built. [Rural Hacking Toolkit](https://creativehubs.net/images/upload/Rural_Hacking_ECHN_Toolkit.pdf) is the result of a 4 days training workshop with the representatives of the following hubs: [Quinta Quinhas](https://quintadaquinhas.pt/), [Sun and Co](https://sun-and-co.com/), [Life at Selgars](https://www.selgars.org/), [The Living Room](https://tlr-coworking.com/), [Dinamo 10](https://www.dinamo10.net/), [Chateau Coliving](https://chateaucoliving.com/), [Wellbeing Economy Alliance](https://weall.org/about-weall), [Vine 21](https://www.vine21.ro/), [Tertulia Farm](https://tertulia.farm/en/), [Sonta Coliving](https://sontacoliving.com/), [Burgas coliving](https://burgascoliving.com/), [Making Rooms](https://www.makingrooms.org/), [Culture Hub Croatia](https://www.chc-prostor.com/), [Buinho](https://buinho.pt/), [Rooral](https://www.rooral.co/) and [Alpiness](https://alpiness-coliving.com/).

![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAABAAAAAKrAQAAAABHbcI5AAAAAnRSTlMAAHaTzTgAAABsSURBVHja7cExAQAAAMKg9U9tDB+gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADgbWDoAAdt1W50AAAAASUVORK5CYII= "Entre-Culturas-3-26")

![](https://anceu.com/wp-content/uploads/2023/10/Entre-Culturas-3-26-1024x683.jpg "Entre-Culturas-3-26")

Rural Hacking community
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAzYAAAKNAQAAAADaTsPuAAAAAnRSTlMAAHaTzTgAAABZSURBVHja7cExAQAAAMKg9U9tB2+gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACA1wAJVwABNhZDCwAAAABJRU5ErkJggg== "Screenshot from 2024-03-05 15-55-46")

![](https://anceu.com/wp-content/uploads/2024/03/Screenshot-from-2024-03-05-15-55-46.jpg "Screenshot from 2024-03-05 15-55-46")

![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAzYAAAKNAQAAAADaTsPuAAAAAnRSTlMAAHaTzTgAAABZSURBVHja7cExAQAAAMKg9U9tB2+gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACA1wAJVwABNhZDCwAAAABJRU5ErkJggg== "Screenshot from 2024-03-05 15-55-40")

![](https://anceu.com/wp-content/uploads/2024/03/Screenshot-from-2024-03-05-15-55-40.jpg "Screenshot from 2024-03-05 15-55-40")